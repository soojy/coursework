...
var Server = class {
  ...
  async respond(request, options = {}) {
    ...
    if (!this.options.hooks) {
      const module2 = await Promise.resolve().then(() => (init_hooks_15219bbf(), hooks_15219bbf_exports));
      this.options.hooks = {
...
var manifest = {
  ...
  _: {
    entry: { "file": "start-d90f4b7b.js", "js": ["start-d90f4b7b.js", "chunks/index-8ce0ac01.js"], "css": [] },
    nodes: [
